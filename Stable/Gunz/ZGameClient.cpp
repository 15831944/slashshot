...
int ZGameClient::OnResponseMatchLogin(const MUID& uidServer, int nResult, const char* szServerName, const MMatchServerMode::MMatchServerMode nServerMode,
...
//	wsprintf(szText, "당신은 채널 '%s'에 입장하셨습니다.", szChannelName);
	...
	{
	case MMatchServerMode::MSM_TEST:
		{
//			wsprintf(szText, "레벨제한을 원치 않으시면 자유채널을 이용해 주시기 바랍니다.");
		...
		break;
	case MMatchServerMode::MSM_LADDER:
		{
//			wsprintf(szText, "리그게임은 채널에 상관없이 모든사용자들과 겨루게 됩니다.");
		...
		break;
	case MMatchServerMode::MSM_CLAN:
		{
