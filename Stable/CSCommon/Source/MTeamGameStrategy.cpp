...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
MBaseTeamGameStrategy* MBaseTeamGameStrategy::GetInstance(MMatchServerMode::MMatchServerMode nServerMode)
{
	switch (nServerMode)
	{
	case MMatchServerMode::MMatchServerMode::MSM_LADDER:
		return MLadderGameStrategy::GetInstance();
	case MMatchServerMode::MMatchServerMode::MSM_TEST:
