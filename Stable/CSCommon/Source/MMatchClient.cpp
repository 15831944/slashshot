...
MMatchClient::MMatchClient()
{
	...
	m_szServerName[0] = 0;
	m_nServerMode = MMatchServerMode::MSM_NORMAL;
...
//				unsigned char *szRandomValue = (unsigned char*)MGetBlobArrayElement(pBlob1, 0);
				...
				OnResponseMatchLogin(pCommand->GetSenderUID(), nResult, szServerName, MMatchServerMode::MMatchServerMode(nServerMode),
...
int MMatchClient::OnResponseMatchLogin(const MUID& uidServer, int nResult, const char* szServerName,
									   const MMatchServerMode::MMatchServerMode nServerMode,
