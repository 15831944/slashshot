...
{
	if ((MGetServerConfig()->GetServerMode() != MMatchServerMode::MMatchServerMode::MSM_TEST) &&
		(MGetServerConfig()->GetServerMode() != MMatchServerMode::MMatchServerMode::MSM_TEST)) return;
