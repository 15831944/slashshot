...
//	if ((MGetServerConfig()->GetServerMode() == MMatchServerMode::MMatchServerMode::MSM_LADDER) || (MGetServerConfig()->GetServerMode() == MMatchServerMode::MMatchServerMode::MSM_CLAN))
	{
