...
void MMatchRuleSurvival::SendGameResult()
{
	...
	if(MMatchServerMode::MMatchServerMode::MSM_TEST != MGetServerConfig()->GetServerMode() )  return;
...
{
	if(MMatchServerMode::MMatchServerMode::MSM_TEST == MGetServerConfig()->GetServerMode() )
	{
...
{
	// 현재 서버가 퀘스트 서버일 경우에만 가능하게 함.
	if(MMatchServerMode::MMatchServerMode::MSM_TEST != MGetServerConfig()->GetServerMode() )  return false;
...
{
	if(MMatchServerMode::MMatchServerMode::MSM_TEST == MGetServerConfig()->GetServerMode() && true == MGetServerConfig()->IsEnabledSurvivalMode())
	{
		MakeStageGameInfo();
