...
MMatchConfig::MMatchConfig()
{
	...
	m_nServerPort					= 0;
	m_nServerUDPPort				= 0;
	m_nServerMode					= MMatchServerMode::MSM_TEST;
...
bool MMatchConfig::Create()
{
	...
	if (!stricmp(szServerMode, SERVER_CONFIG_SERVERMODE_NORMAL)) m_nServerMode = MMatchServerMode::MSM_NORMAL;
	else if (!stricmp(szServerMode, SERVER_CONFIG_SERVERMODE_CLAN)) m_nServerMode = MMatchServerMode::MMatchServerMode::MSM_CLAN;
	else if (!stricmp(szServerMode, SERVER_CONFIG_SERVERMODE_LADDER)) m_nServerMode = MMatchServerMode::MMatchServerMode::MSM_LADDER;
	else if (!stricmp(szServerMode, SERVER_CONFIG_SERVERMODE_EVENT)) m_nServerMode = MMatchServerMode::MMatchServerMode::MSM_EVENT;
	else if (!stricmp(szServerMode, SERVER_CONFIG_SERVERMODE_TEST)) m_nServerMode = MMatchServerMode::MMatchServerMode::MSM_TEST;
	else { _ASSERT(0); }
