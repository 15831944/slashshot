...
private:
	...
	MMatchServerMode::MMatchServerMode	m_nServerMode;				///< 서버모드
...
public:
	...
	const MMatchServerMode::MMatchServerMode		GetServerMode()		{ return m_nServerMode; }
	...
	const bool IsClanServer() { return (MMatchServerMode::MMatchServerMode::MSM_TEST == m_nServerMode); }
...
inline bool QuestTestServer() { return (MGetServerConfig()->GetServerMode() == MMatchServerMode::MMatchServerMode::MSM_TEST); }
